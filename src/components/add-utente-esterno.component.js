...
const AddUtenteEsterno = () => {
    ...
    const idAnnuncioAMano = { idAnnuncioAMano: 69 }
    ...
    const handleAddUtenteEsterno = (event) => {

      event.preventDefault();             //Serve ad impedire il reload automatico del form (utile per debug console)
      //handleStampa();
      //utenteEsternoService.addUtenteEsterno(email, telefono, ragioneSociale, idAnnuncioAMano.idAnnuncioAMano);
      utenteEsternoService.addUtenteEsternoAnnuncio(email, telefono, ragioneSociale, idAnnuncioAMano.idAnnuncioAMano);    
    ...
    return (
        <div className="col-md-6">
          <div>          
            ...
            >*/}
            <Form 
              onSubmit={handleAddUtenteEsterno}
              > 
              ...
              <div className="form-group">
                <label htmlFor="fax">Ragione Sociale</label>
                <Input
                  type="text"
                  className="form-control"
                  name="fax"
                  value={ragioneSociale}
                  onChange={e => onChangeRagioneSociale(e.target.value)}
                  validations={[required]}
                />
              </div>
...
export default AddUtenteEsterno;
